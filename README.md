...
graph TD
    ...
    %% Styling links for clarity - FOTA is Red
    linkStyle 0,1,2,3,4,5 stroke:#ff0000,stroke-width:2px;
    
    %% Styling links for clarity - Telemetry is Green
    linkStyle 6,7,8,9,10 stroke:#00ff00,stroke-width:2px;
```
